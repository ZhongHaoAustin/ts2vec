...
model = TS2Vec(input_dims=1, device="cpu", output_dims=20)
...
test_repr = model.encode(
    test_data, encoding_window="full_series"
)  # n_instances x output_dims

# Sliding inference for test set
test_repr = model.encode(
    test_data, causal=True, sliding_length=1, sliding_padding=50
